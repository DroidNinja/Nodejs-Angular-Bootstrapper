...
exports.article = function(req, res, next, id) {
    console.log('id => ' + id);
    db.Article.find({where: {id: id}, include: [{model:db.User, attributes:['id', 'primaryEmail', 'displayName']}]}).then(function(article){
        if(!article) {
...
exports.all = function(req, res) {
    db.Article.findAll({include: [{model:db.User, attributes: ['id', 'primaryEmail', 'displayName']}]}).then(function(articles){
